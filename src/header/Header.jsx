    ...
    <Navbar expand="lg" className="navbar_container">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="ms-auto navbar_items">
          ...
          <DropdownButton title={selectedLanguage}>
            <Dropdown.Item onClick={() => changeLanguage('English')}>English</Dropdown.Item>
            <Dropdown.Item onClick={() => changeLanguage('Hindi')}>Hindi</Dropdown.Item>
            <Dropdown.Item onClick={() => changeLanguage('German')}>German</Dropdown.Item>
